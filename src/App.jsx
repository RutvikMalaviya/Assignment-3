...
const ClientCard = () => {
  ...
  const [likedClients, setLikedClients] = useState({});
  ...
  useEffect(() => {
    ...
    fetch("https://jsonplaceholder.typicode.com/users")
      ...
      .catch((error) => alert("Error fetching client data:", error));
  }, []);

  const toggleLike = (id) => {
    setLikedClients((prev) => ({
      ...prev,
      [id]: !prev[id],
    }));
  };
  ...
  return (
    <div className="flex flex-wrap justify-start items-center h-screen  p-4 ">
      {clients.map((client) => (
        <div
          key={client.id}
          className="bg-white shadow-md w-full max-w-xs ml-10 mb-9 border border-gray-300"
        >
          <img
            src={
            ...
            alt="Client"
            className="w-full h-48 bg-custom-grey"
          />
          <div className="p-4">
            ...
            <div className="flex justify-between bg-custom-grey h-14">
              <button
                onClick={() => toggleLike(client.id)}
                className={`px-4 py-2 rounded text-white ${
                  likedClients[client.id] ? "text-red-500" : "text-red-500"
                }`}
              >
                {likedClients[client.id] ? (
                  <svg
                    viewBox="64 64 896 896"
                    class=""
                    data-icon="heart"
              ...
              <button
                ...
                className="px-4 py-2 rounded text-gray hover:text-blue-600"
              >
                <svg viewBox="64 64 896 896" class="" data-icon="edit" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M257.7 752c2 0 4-.2 6-.5L431.9 722c2-.4 3.9-1.3 5.3-2.8l423.9-423.9a9.96 9.96 0 0 0 0-14.1L694.9 114.9c-1.9-1.9-4.4-2.9-7.1-2.9s-5.2 1-7.1 2.9L256.8 538.8c-1.5 1.5-2.4 3.3-2.8 5.3l-29.5 168.2a33.5 33.5 0 0 0 9.4 29.8c6.6 6.4 14.9 9.9 23.8 9.9zm67.4-174.4L687.8 215l73.3 73.3-362.7 362.6-88.9 15.7 15.6-89zM880 836H144c-17.7 0-32 14.3-32 32v36c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-36c0-17.7-14.3-32-32-32z"></path></svg>
              </button>
              <button
                onClick={() => deleteClient(client.id)}
                className="px-4 py-2 rounded tex-gray-500 hover:text-blue-600"
              >
            ...
            >
              ...
              <div className="mb-4 ">
                ...
                <input
                  type="email"
                  name="email"
                  defaultValue={modalClient.email}
                  className="w-full p-2 border rounded"
                  required
                />
              </div>
              <div className="mb-4">
                ...
                <input
                  type="text"
                  name="phone"
                  defaultValue={modalClient.phone}
                  className="w-full p-2 border rounded"
                  required
                />
              </div>
              <div className="mb-4">
                ...
                <input
                  type="text"
                  name="website"
                  defaultValue={modalClient.website}
                  className="w-full p-2 border rounded"
                  required
                />
              </div>
